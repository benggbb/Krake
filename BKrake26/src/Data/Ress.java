...
public class Ress {
	...
	static public ArrayList<Integer> bBuffer = new ArrayList<>();
	...
	static public ArrayList<Integer> Methode_Name = new ArrayList<>();
	static public ArrayList<List<Integer>> MethodeContent = new ArrayList<>();
	static public HashMap<Integer, Code> Blocks = new HashMap<>();
	...
	public static void Bufferflush() {
		...
		Methode_Name = new ArrayList<Integer>();
		Blocks = new HashMap<>();
